...
• Информационные программы: которые тестируют компьютер или отдельные компоненты, и выдают подробную информацию о его состоянию, функциональности, и возможных программных и физических неполадках.
